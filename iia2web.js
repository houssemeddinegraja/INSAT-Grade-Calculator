const sem1Config = [
    ...
    {coeff: 3, ds: "AutoDS", ex: "AutoEx", tp: "AutoTP"},
    {coeff: 1.5, ds:"FrançaisDS", ex:"FrançaisEx", tp:null},
    {coeff: 1.5, ds: "ComptabilitéDS", ex: "ComptabilitéEx", tp: null},
    ...
    {coeff: 3.5, ds:"SEDS", ex:"SEEx", tp: null},
    {coeff: 3, ds: "MSIDS", ex: "MSIEx", tp: "MSITP"},
    {coeff: 3.5, ds: "ElectrotechniqueDS", ex: "ElectrotechniqueEx", tp: "ElectrotechniqueTP"}
];

const sem2Config = [
    {coeff: 3, ds: "AlgebreDS", ex:"AlgebreEx", tp:null},
    {coeff: 3, ds: "AnalyseDS", ex: "AnalyseEx", tp: null},
    {coeff: 2, ds: "RéseauxDS", ex: "RéseauxEx", tp: null},
    {coeff: 1.5, ds:"Anglais2DS", ex:"Anglais2Ex", tp:null},
    {coeff: 1, ds: "GestionDS", ex: "GestionEx", tp: null},
    {coeff: 2, ds: "SignalDS", ex: "SignalEx", tp: null},
    {coeff: 1, ds: "DroitDS", ex: "DroitEx", tp: null},
    {coeff: 3, ds: "ElecDS", ex:"ElecEx", tp: "ElecTP"},
    {coeff: 3, ds: "PuisDS", ex: "PuisEx", tp: "PuisTP"},
    {coeff: 3, ds: "ProcDS", ex:"ProcEx", tp: "ProcTP"},
    {coeff: 3, ds: "AutoConDS", ex: "AutoConEx", tp: "AutoConTP"},
    {coeff: 3, ds: "CapteursDS", ex: "CapteursEx", tp: "CapteursTP"}
];
